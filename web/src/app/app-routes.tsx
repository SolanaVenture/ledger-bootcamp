...
const LedgerBootcampFeature = lazy(
  () => import('./ledger-bootcamp/ledger-bootcamp-feature')
);
const links: { label: string; path: string }[] = [
  { label: 'Account', path: '/account' },
  { label: 'Clusters', path: '/clusters' },
  { label: 'LedgerBootcamp Program', path: '/ledger-bootcamp' },
];
...
const routes: RouteObject[] = [
  ...
  { path: 'ledger-bootcamp/*', element: <LedgerBootcampFeature /> },
];
